...
Create a new album called 'Summer 2011' under the 'Holidays' album and a cateogory "Trees" under the "Nature" category:<br>
`zoph --new --parent "Holidays" --album "Summer 2011" --parent "Nature" --category "Trees"`<br>`
...
**Example:** `zoph -r IMG_1234.JPG Photos/`<br>
