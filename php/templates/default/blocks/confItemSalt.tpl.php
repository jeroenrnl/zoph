...
?>
    <div>
        ...
        <div class="generate">
            <input type="text" id="<?php echo $tpl_id ?>" pattern="<?php echo $tpl_regex ?>" title="<?php echo $tpl_title ?>" name="<?php echo $tpl_name ?>" value="<?php echo $tpl_value; ?>" size="<?php echo $tpl_size ?>" <?php echo $tpl_req ?>>
