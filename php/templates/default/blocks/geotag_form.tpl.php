        ...
        <form class="geotag" action="tracks.php">
            ...
            <fieldset class="geotag">
                ...
                <fieldset class="checkboxlist">
                    ...
                    <input type="checkbox" id="validtz" name="_validtz" value="1" checked>
                        <?php echo translate("Only photos with a valid timezone"); ?><br>
                </fieldset>
                ...
                <fieldset class="checkboxlist">
                    ...
                    <input type="checkbox" id="overwrite" name="_overwrite" value="1">
                      <?php echo translate("Overwrite existing geo-information"); ?><br>
                </fieldset>
            ...
            <fieldset class="geotag">
                ...
                <fieldset class="checkboxlist">
                    ...
                    <?php echo translate("Interpolate between points"); ?><br>
                    <input type="radio" name="_interpolate" id="interpolate2" value="nearest">
                    <?php echo translate("Use nearest point");  ?>
                </fieldset>
                ...
                <?php echo translate("seconds"); ?>
                <div class="inputhint">
                    <?php echo translate("Do not interpolate if time between points is more " .
                        "than this"); ?>
                </div>
            </fieldset>
            <fieldset class="geotag">
                ...
                <div class="formtext">
                    <?php echo translate("To ensure that the geotagging operation goes well, " .
