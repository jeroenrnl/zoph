...
class validator {
     ...
     * Uses code by Jason Geiger and include()s "cdi@thewebmasters.net"'s Htpasswd PHP class
     */
    function htpasswd_validate() {
        ...
        */
        ...
        // For code reuse's sake, perhaps this should be its own function, and in each we just say "$user = default_user();"
        else if (DEFAULT_USER) {
                $user = new user(DEFAULT_USER);
        }
        return $user;
